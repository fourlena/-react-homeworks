...
function Clock() {
    ...
    let formatterDate= new Intl.DateTimeFormat("ru", { year: "numeric", month: "numeric", day: "numeric" });
    let formatterTime= new Intl.DateTimeFormat("ru", { hour: "numeric", minute: "numeric",second: "numeric" });
